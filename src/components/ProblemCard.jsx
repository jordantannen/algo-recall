...
export default function ProblemCard({ problem, user, onProblemAttempt }) {
    ...
    return (
        <div className='bg-gray-800 rounded-lg p-4 border border-gray-700 shadow-sm hover:border-gray-600 transition-colors'>
            ...
            {/* Keys added below to force fresh DOM nodes on toggle */}
            {showButtons ? (
                <div key="review-options" className='flex gap-2 mt-4 pt-4 border-t border-gray-700'>
                    <button
                ...
                <div key="action-buttons" className='mt-4 pt-3 border-t border-gray-700 flex justify-end gap-2'>
                    <button
